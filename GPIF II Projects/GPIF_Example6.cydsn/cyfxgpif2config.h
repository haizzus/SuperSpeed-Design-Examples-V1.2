/*
 * Project Name: GPIF_Example6.cyfx
 * Time : 06/28/2014 12:21:47
 * Device Type: FX3
 * Project Type: GPIF2
 *
 *
...
#define WAIT4RD 1
#define READ 4
#define WAIT4RD_DMA 5
#define WRITE 3
#define WAIT4WR_DMA 7
#define SIGNAL 6
#define WAIT4WR 2
...
uint16_t CyFxGpifTransition[]  = {
    0x0000, 0xAAAA, 0xFFFF, 0x7777, 0x8888, 0x5555, 0xCCCC
};
...
CyU3PGpifWaveData CyFxGpifWavedata[]  = {
    {{0x3E734201,0x0000C008,0x80000080},{0x00000000,0x00000000,0x00000000}},
    {{0x3E734302,0x04010008,0x80000080},{0x5E728203,0x0000000C,0x80000000}},
    {{0x3E734201,0x0000C008,0x80000080},{0x1E739404,0x24000004,0x80000000}},
    {{0x3E734201,0x0000C008,0x80000080},{0x4E734207,0x000000CA,0x80000080}},
    {{0x4E734305,0x0400010A,0x80000080},{0x3E734302,0x04010008,0x80000080}},
    {{0x1E739404,0x24000004,0x80000000},{0x3E734302,0x04010008,0x80000080}},
    {{0x3E734302,0x04010008,0x80000080},{0x00000000,0x00000000,0x00000000}},
    {{0x5E728203,0x0000000C,0x80000000},{0x3E734201,0x0000C008,0x80000080}},
    {{0x00000000,0x00000000,0x00000000},{0x00000000,0x00000000,0x00000000}},
    {{0x4E734305,0x0400010A,0x80000080},{0x00000000,0x00000000,0x00000000}},
    {{0x4E734305,0x0400010A,0x80000080},{0x2E739C06,0x00000000,0x80000100}}
};
...
uint8_t CyFxGpifWavedataPosition[]  = {
    0,1,2,3,4,5,6,7,8,8,8,8,8,8,8,8,8,8,8,8,8,8,8,8,8,8,8,8,8,8,8,8,
    8,8,8,8,8,8,8,8,8,8,8,8,8,8,8,8,8,8,8,8,8,8,8,8,8,8,8,8,8,8,8,8,
    0,1,2,3,4,5,6,7,8,8,8,8,8,8,8,8,8,8,8,8,8,8,8,8,8,8,8,8,8,8,8,8,
    8,8,8,8,8,8,8,8,8,8,8,8,8,8,8,8,8,8,8,8,8,8,8,8,8,8,8,8,8,8,8,8,
    0,1,2,3,9,5,6,7,8,8,8,8,8,8,8,8,8,8,8,8,8,8,8,8,8,8,8,8,8,8,8,8,
    8,8,8,8,8,8,8,8,8,8,8,8,8,8,8,8,8,8,8,8,8,8,8,8,8,8,8,8,8,8,8,8,
    0,1,2,3,10,5,6,7
};
...
uint32_t CyFxGpifRegValue[]  = {
    ...
    0x03040002,  /*  CY_U3P_PIB_GPIF_BUS_CONFIG2 */
    ...
    0x0000FFE3,  /*  CY_U3P_PIB_GPIF_CTRL_BUS_DEFAULT */
    ...
    0x00000FFF,  /*  CY_U3P_PIB_GPIF_DATA_COUNT_RESET */
    0x00000000,  /*  CY_U3P_PIB_GPIF_DATA_COUNT_LIMIT */
