...
#ifndef _INCLUDED_SLAVEFIFOREADWRITE_
#define _INCLUDED_SLAVEFIFOREADWRITE_
#include "cyu3types.h"
#include "cyu3gpif.h"
...
uint16_t CyFxGpifTransition[]  = {
    0x0000, 0xFFFF, 0x5555, 0x3333, 0xAAAA, 0xCCCC
};
...
CyU3PGpifWaveData CyFxGpifWavedata[]  = {
    {{0x2E702001,0x0400C106,0x80000000},{0x00000000,0x00000000,0x00000000}},
    {{0x4E700204,0x2000000A,0x80000000},{0x4E738103,0x04000000,0x80000000}},
    {{0x1E739C02,0x00000000,0x80100000},{0x2E704005,0x0000010A,0x80000000}},
    {{0x4E700204,0x2000000A,0x80000000},{0x1E739C02,0x00000000,0x80100000}}
};
...
uint32_t CyFxGpifRegValue[]  = {
    ...
    0x54105500,  /*  CY_U3P_PIB_GPIF_CTRL_BUS_DIRECTION */
    0x0000FBFB,  /*  CY_U3P_PIB_GPIF_CTRL_BUS_DEFAULT */
...
#endif   /* _INCLUDED_SLAVEFIFOREADWRITE_ */
