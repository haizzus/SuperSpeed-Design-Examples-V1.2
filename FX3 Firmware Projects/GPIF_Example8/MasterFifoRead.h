/*
 * Project Name: GPIF_Example8.cyfx
 * Time : 12/05/2014 09:13:05
 * Device Type: FX3
 * Project Type: GPIF2
 *
 *
...
#ifndef _INCLUDED_MASTERFIFOREAD_
#define _INCLUDED_MASTERFIFOREAD_
#include "cyu3types.h"
#include "cyu3gpif.h"
...
#define START 0
#define MODE 1
#define WAIT4RD_FIFO 2
#define PREREAD123 5
#define READ 6
#define COMMIT 4
#define POSTREAD012 7
#define PREREAD0 3
...
uint16_t CyFxGpifTransition[]  = {
    0x0000, 0xFFFF, 0xAAAA, 0x0404, 0xCCCC, 0xF0F0
};
...
CyU3PGpifWaveData CyFxGpifWavedata[]  = {
    {{0x2E738701,0x00000000,0x80000000},{0x00000000,0x00000000,0x00000000}},
    {{0x3E0B4602,0x0800100A,0x80000000},{0x00000000,0x00000000,0x00000000}},
    {{0x1E739C03,0x00001800,0x80000000},{0x1E739C04,0x00000000,0x80100000}},
    {{0x1E739C05,0x00001900,0x80800000},{0x00000000,0x00000000,0x00000000}},
    {{0x2E730206,0x28010008,0x80000000},{0x00000000,0x00000000,0x00000000}},
    {{0x3E0B4602,0x0800100A,0x80000000},{0x1E739C07,0x28000000,0x80800000}}
};
...
#endif   /* _INCLUDED_MASTERFIFOREAD_ */
