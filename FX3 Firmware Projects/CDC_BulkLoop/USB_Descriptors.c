/*
 * These descriptors define a Composite device with two interfaces: CDC + BulkLoop
 *
 *
...
// Note: 3 interfaces, first two are CDC (Call Management and Data), third is Bulk Loop
    ...
    0x01,                           /* Mult.: Max number of packets : 1 */
    0x00,0x04,             			/* Bytes per interval : 1024 */
// Now define the BulkLoop interface
	...
	0x07,                           /* Descriptor size */
	CY_U3P_USB_ENDPNT_DESCR,        /* Endpoint descriptor type */
	CY_FX_EP_PRODUCER_BULKLOOP,     /* Endpoint address and description */
	CY_U3P_USB_EP_BULK,             /* Bulk endpoint type */
	0x00,0x04,                      /* Max packet size = 1024 bytes */
	...
	0x06,                           /* Descriptor size */
	CY_U3P_SS_EP_COMPN_DESCR,       /* SS endpoint companion descriptor type */
	0x00,    						/* Max no. of packets in a burst(0-15) - 0: burst 1 packet at a time */
	...
	0x07,                           /* Descriptor size */
	CY_U3P_USB_ENDPNT_DESCR,        /* Endpoint descriptor type */
	CY_FX_EP_CONSUMER_BULKLOOP,     /* Endpoint address and description */
	CY_U3P_USB_EP_BULK,             /* Bulk endpoint type */
	0x00,0x04,                      /* Max packet size = 1024 bytes */
	0x00,                           /* Servicing interval for data transfers : 0 for Bulk */
...
const uint8_t CyFxUSBProductDscr[] __attribute__ ((aligned (32))) =
{
    26,                           	/* Descriptor size */
    CY_U3P_USB_STRING_DESCR,        /* Device descriptor type */
    'C',0,'D',0,'C',0,'_',0,'B',0,'u',0,'l',0,'k',0,'L',0,'o',0,'o',0,'p',0
};
...
const uint8_t CyFxUSBInterface2Dscr[] __attribute__ ((aligned (32))) =
{
    18,                           	/* Descriptor size */
    CY_U3P_USB_STRING_DESCR,        /* Device descriptor type */
    'B',0,'u',0,'l',0,'k',0,'L',0,'o',0,'o',0,'p',0
};
