/*
 * Project Name: GPIF_Example4.cyfx
 * Time : 12/05/2014 16:05:25
 * Device Type: FX3
 * Project Type: GPIF2
 *
 *
...
#ifndef _INCLUDED_SLAVEFIFOREAD_
#define _INCLUDED_SLAVEFIFOREAD_
#include "cyu3types.h"
#include "cyu3gpif.h"
...
uint16_t CyFxGpifTransition[]  = {
    0x0000, 0xFFFF, 0x5555, 0xAAAA, 0xCCCC
};
...
CyU3PGpifWaveData CyFxGpifWavedata[]  = {
    {{0x2E738001,0x00000100,0x80000000},{0x00000000,0x00000000,0x00000000}},
    {{0x3E700203,0x20000008,0x80000000},{0x00000000,0x00000000,0x00000000}},
    {{0x1E739C02,0x00000000,0x80100000},{0x2E704004,0x00000108,0x80000000}},
    {{0x3E700203,0x20000008,0x80000000},{0x1E739C02,0x00000000,0x80100000}}
};
...
#endif   /* _INCLUDED_SLAVEFIFOREAD_ */
