/*
 * Project Name: GPIF_Example9.cyfx
 * Time : 12/05/2014 11:13:50
 * Device Type: FX3
 * Project Type: GPIF2
 *
 *
...
#ifndef _INCLUDED_MASTERFIFOWRITE_
#define _INCLUDED_MASTERFIFOWRITE_
#include "cyu3types.h"
#include "cyu3gpif.h"
...
#define WRITE 4
#define POSTWRITE012 5
#define PREWRITE012 3
...
uint16_t CyFxGpifTransition[]  = {
    0x0000, 0xFFFF, 0x5555, 0x4444, 0xAAAA
};
...
CyU3PGpifWaveData CyFxGpifWavedata[]  = {
    ...
    {{0x3E734502,0x0C000400,0x80000000},{0x00000000,0x00000000,0x00000000}},
    {{0x1E739C03,0x0C0004C0,0x80800000},{0x00000000,0x00000000,0x00000000}},
    {{0x4E739804,0x0C0000C0,0x80000000},{0x00000000,0x00000000,0x00000000}},
    {{0x1E739C05,0x0C000000,0x80800000},{0x00000000,0x00000000,0x00000000}}
};
...
#endif   /* _INCLUDED_MASTERFIFOWRITE_ */
