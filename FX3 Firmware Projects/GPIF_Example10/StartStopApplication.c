...
#include "MasterFifoReadWrite.h"				// File generated by GPIF Designer
//#include "MasterFifoRead.h"				// File generated by GPIF Designer
char* CyFxGpifConfigName = { "MasterFifoReadWrite" };
...
CyU3PReturnStatus_t StartGPIF(void)
{
	...
	Status = CyU3PGpifSocketConfigure(2, GPIF_PRODUCER_SOCKET, 8, CyFalse, 1);
	CheckStatus("Set Producer Watermark", Status);
	Status = CyU3PGpifSocketConfigure(3, GPIF_CONSUMER_SOCKET, 7, CyFalse, 1);
	CheckStatus("Set Consumer Watermark", Status);
