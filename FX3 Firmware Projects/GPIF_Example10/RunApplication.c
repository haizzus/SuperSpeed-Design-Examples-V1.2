// Demonstrate GPIF as a Master FIFO sending and receiving data from the CPLD
//
// GPIF_Example10 uses MasterFifoReadWrite.h and CPLD requires CPLDasFifoSlave.xsvf
// Preset Button[6] = 1 to enable READ from CPLD and = 0 to WRITE to CPLD
//
...
void CyFxApplicationDefine(void)
{
    ...
    Status = CyU3PThreadCreate(&ThreadHandle, 	// Handle to my Application Thread
            "11:GPIF_Example10",               	// Thread ID and name
