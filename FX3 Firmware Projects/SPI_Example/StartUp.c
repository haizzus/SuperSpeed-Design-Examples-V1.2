...
{
	// When using SPI rather than UART the CTS line becomes the SSN line
	// I need this for selecting SPI devices so I must give up IndicateError on this example
	// On your hardware DO NOT use CTS as an Indicator LED - there are other GPIOs that you can use
	return;
...
//			ioConfig.isDQ32Bit = CyTrue;
			...
			ioConfig.lppMode   = CY_U3P_IO_MATRIX_LPP_DEFAULT;		//CY_U3P_IO_MATRIX_LPP_SPI_ONLY;
