...
extern void SendCharacter(char InputChar);
...
// In this example the characters typed on the debug console are sent to the PC Host via the CDC Interface
		SendCharacter(InputChar);
