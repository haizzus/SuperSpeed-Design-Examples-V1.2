/*
 * Project Name: GPIF_Example3.1.cyfx
 * Time : 11/25/2014 17:23:15
 * Device Type: FX3
 * Project Type: GPIF2
 *
 *
...
#ifndef _INCLUDED_CPLDINCONTROL_
#define _INCLUDED_CPLDINCONTROL_
#include "cyu3types.h"
#include "cyu3gpif.h"
...
CyU3PGpifWaveData CyFxGpifWavedata[]  = {
    {{0x1E738001,0x00000300,0x80000000},{0x00000000,0x00000000,0x00000000}},
    {{0x2E738002,0x20000000,0x80000000},{0x00000000,0x00000000,0x00000000}},
    {{0x3E739C03,0x00000000,0x80000100},{0x00000000,0x00000000,0x00000000}}
};
...
uint32_t CyFxGpifRegValue[]  = {
    0x80000330,  /*  CY_U3P_PIB_GPIF_CONFIG */
    0x0000008C,  /*  CY_U3P_PIB_GPIF_BUS_CONFIG */
    ...
    0x00101100,  /*  CY_U3P_PIB_GPIF_CTRL_BUS_DIRECTION */
...
#endif   /* _INCLUDED_CPLDINCONTROL_ */
