/*
 * Project Name: GPIF_Example2.1.cyfx
 * Time : 11/25/2014 14:23:14
 * Device Type: FX3
 * Project Type: GPIF2
 *
 *
...
#ifndef _INCLUDED_SUPPLYDUALGPIFDATA_
#define _INCLUDED_SUPPLYDUALGPIFDATA_
#include "cyu3types.h"
#include "cyu3gpif.h"
...
CyU3PGpifWaveData CyFxGpifWavedata[]  = {
    {{0x1E738001,0x00000100,0x80000080},{0x00000000,0x00000000,0x00000000}},
    {{0x1E701402,0x24000104,0x80000060},{0x00000000,0x00000000,0x00000000}},
    {{0x1E701303,0x20000104,0x80000090},{0x1E738001,0x00000100,0x80000080}},
    {{0x1E701402,0x24000104,0x80000060},{0x1E738001,0x00000100,0x80000080}}
};
...
#endif   /* _INCLUDED_SUPPLYDUALGPIFDATA_ */
