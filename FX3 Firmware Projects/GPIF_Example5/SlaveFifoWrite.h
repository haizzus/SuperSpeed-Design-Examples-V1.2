/*
 * Project Name: GPIF_Example5.cyfx
 * Time : 12/05/2014 16:18:44
 * Device Type: FX3
 * Project Type: GPIF2
 *
 *
...
#ifndef _INCLUDED_SLAVEFIFOWRITE_
#define _INCLUDED_SLAVEFIFOWRITE_
#include "cyu3types.h"
#include "cyu3gpif.h"
...
CyU3PGpifWaveData CyFxGpifWavedata[]  = {
    {{0x1E738101,0x040000C0,0x80000000},{0x00000000,0x00000000,0x00000000}},
    {{0x2E738102,0x04000000,0x80000000},{0x00000000,0x00000000,0x00000000}}
};
...
uint32_t CyFxGpifRegValue[]  = {
    ...
    0x0000007C,  /*  CY_U3P_PIB_GPIF_BUS_CONFIG */
...
#endif   /* _INCLUDED_SLAVEFIFOWRITE_ */
